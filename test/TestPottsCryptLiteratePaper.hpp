...
public:
	 ...
	 *
	 * Example visualisations of the simulations from Figure 2 can be found at
	 * https://www.youtube.com/watch?v=pmj_KOX1LIg
	 * and
	 * https://www.youtube.com/watch?v=gszAMMQAKUA
	 *
